...
function getDb() {
  if (!globalForDb.__preorder_db) {
    ...
    if (process.env.NODE_ENV !== "production") {
      globalForDb.__preorder_db = instance;
    } else {
      // In production, still reuse across the module's lifetime,
      // just don't stash it on globalThis to avoid confusion with dev HMR.
      globalForDb.__preorder_db = instance;
    }
  }
